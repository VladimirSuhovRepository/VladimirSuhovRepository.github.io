...
module.exports = "<h1 mat-dialog-title>Регистрация</h1>\n<div mat-dialog-content>\n    <mat-vertical-stepper linear #stepper>\n        <mat-step>\n            <form>\n                <ng-template matStepLabel>Кто вы?</ng-template>\n                <mat-button-toggle-group aria-label=\"Категория\" vertical style=\"padding: 10px;margin: 10px;\">\n                    <mat-button-toggle value=\"user\">Пользователь</mat-button-toggle>\n                    <mat-button-toggle value=\"admin\">Администратор</mat-button-toggle>\n                </mat-button-toggle-group>\n                <div>\n                    <button mat-button matStepperNext>Далее</button>\n                </div>\n            </form>\n        </mat-step>\n        <mat-step>\n            <form>\n                <ng-template matStepLabel>Email</ng-template>\n                <mat-form-field class=\"example-full-width\">\n                    <input matInput placeholder=\"Email\" style=\"margin: 10px\">\n                </mat-form-field>\n                <div>\n                    <button mat-button matStepperPrevious>Далее</button>\n                    <button mat-button matStepperNext>Назад</button>\n                </div>\n            </form>\n        </mat-step>\n        <mat-step>\n            <form>\n                <ng-template matStepLabel>Мобильный телефон:</ng-template>\n                <mat-form-field class=\"example-full-width\">\n                    <span matPrefix>+375 &nbsp;</span>\n                    <input type=\"tel\" matInput placeholder=\"Telephone\">                   \n                </mat-form-field> \n                <button mat-button>Выслать код</button>\n                <mat-form-field class=\"example-full-width\">\n                    <input matInput #postalCode maxlength=\"4\" placeholder=\"Код подтверждения\" >\n                    <mat-hint align=\"end\">{{postalCode.value.length}} / 4</mat-hint>\n                  </mat-form-field>\n                <div style=\"margin-top: 10px\">\n                    <button mat-button matStepperPrevious>Далее</button>\n                    <button mat-button matStepperNext>Назад</button>\n                </div>\n            </form>\n        </mat-step>\n        <mat-step>\n            <ng-template matStepLabel>Done</ng-template>\n            You are now done.\n            <div>\n                <button mat-button matStepperPrevious>Back</button>\n                <button mat-button (click)=\"stepper.reset()\">Reset</button>\n            </div>\n        </mat-step>\n    </mat-vertical-stepper>\n</div>"
...
var routes = [
    {
        path: '',
        loadChildren: function () { return _modules_home_home_module__WEBPACK_IMPORTED_MODULE_4__["HomeModule"]; }
    },
    {
        path: 'admin',
        loadChildren: function () { return _modules_admin_admin_module__WEBPACK_IMPORTED_MODULE_3__["AdminModule"]; }
    }
];
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.store.select('user').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) {
            if (res && res.userId) {
                return true;
            }
    ...
    AuthGuard.prototype.validate = function (currentUser, state) {
        if (currentUser) {
            return true;
        }
...
var DesignComponent = /** @class */ (function () {
    function DesignComponent(store, uploadService) {
        this.store = store;
        this.uploadService = uploadService;
    }
    DesignComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select('user').subscribe(function (s) { _this.user = s; });
    };
    DesignComponent.prototype.uploadFile = function (input) {
...
var DishComponent = /** @class */ (function () {
    function DishComponent(dishService, dishTypesService, router, store, uploadService) {
    ...
    DishComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.updateTable();
        this.dishTypesService.getAllDishTypes().subscribe(function (s) { return _this.dishTypes = s; });
        this.selectedDishTypeId = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormControl"](2);
        this.store.select('user').subscribe(function (s) { return _this.user = s; });
    };
    DishComponent.prototype.postDish = function () {
        var _this = this;
        ...
        this.dishService.postDish(this.dish).subscribe(function (s) { return _this.updateTable(); });
    };
    DishComponent.prototype.updateDish = function (dish) {
        var _this = this;
        this.dish.dishTypeId = this.dishType.dishTypeId
        ...
        this.dish.price = this.dish.price
            ? this.dish.price
            : dish.price;
        this.dishService.putDish(this.dish).subscribe(function (s) { return _this.updateTable(); });
    };
    DishComponent.prototype.deleteDish = function (id) {
        var _this = this;
        this.dish.dishTypeId = +this.dishType.dishTypeId;
        this.dishService.removeDish(id).subscribe(function (s) { return _this.updateTable(); });
    };
    DishComponent.prototype.updateTable = function () {
        var _this = this;
        this.dishImage = {};
        this.dishService.getAllDishes().subscribe(function (s) {
            _this.dishes = s;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.dishes);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource.sort = _this.sort;
            console.log(s);
        });
    };
    DishComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    DishComponent.prototype.uploadFile = function (input) {
        this.imageFile = input.files[0];
        this.uploadService.uploadDishImage(this.imageFile, this.dishImage);
    };
    DishComponent.prototype.changeCurrentDishType = function (dishTypeId) {
        this.dishType.dishTypeId = dishTypeId;
    };
    DishComponent.ctorParameters = function () { return [
...
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../register/register.component */ "./src/app/modules/home/components/register/register.component.ts");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, dishService, dishTypesService, store, elementRef, dialog) {
        this.router = router;
        this.dishService = dishService;
        this.dishTypesService = dishTypesService;
        this.store = store;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dishService.getAllDishes().subscribe(function (s) { return _this.dishes = s; });
        this.dishTypesService.getAllDishTypes().subscribe(function (t) { return _this.dishTypes = t; });
        this.store.select('basket').subscribe(function (s) { return s ? _this.basket = s : _this.basket = []; });
        this.store.select('user').subscribe(function (s) { return _this.user = s; });
    };
    HomeComponent.prototype.openRegisterDialog = function () {
        var dialogRef = this.dialog.open(_register_register_component__WEBPACK_IMPORTED_MODULE_9__["RegisterComponent"], {
            width: '400px'
        });
    ...
    HomeComponent.prototype.openLoginDialog = function () {
        var dialogRef = this.dialog.open(_login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], {
            width: '250px'
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log('The dialog was closed');
    ...
    HomeComponent.prototype.getBasketCount = function () {
        var count = 0;
    ...
    HomeComponent.prototype.getFinalBasketPrice = function () {
        var price = 0;
        for (var i = 0; i < this.basket.length; i++) {
    ...
    HomeComponent.prototype.incrementBasketDish = function (basketItem) {
        this.store.dispatch(new src_app_store_actions_backet_actions__WEBPACK_IMPORTED_MODULE_6__["BasketAdd"](basketItem.dish));
        return false;
    };
    HomeComponent.prototype.decrementBasketDish = function (basketItem) {
    ...
    HomeComponent.prototype.addToBasket = function (basket) {
        this.store.dispatch(new src_app_store_actions_backet_actions__WEBPACK_IMPORTED_MODULE_6__["BasketAdd"](basket));
    };
    HomeComponent.prototype.removeFromBasket = function (basket) {
        this.store.dispatch(new src_app_store_actions_backet_actions__WEBPACK_IMPORTED_MODULE_6__["BasketRemove"](basket));
    };
    HomeComponent.prototype.getDishesByType = function (id) {
        var _this = this;
        this.dishService.getDishesByType(id).subscribe(function (s) { return _this.dishes = s; });
        this.dishType = this.dishTypes.find(function (f) { return f.dishTypeId == id; });
    };
    HomeComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userService, router, store, dialogRef, dialog) {
    ...
    LoginComponent.prototype.loginFunction = function () {
        ...
        this.store.select('user').subscribe(function (data) { if (data.userId > 0) {
            _this.success(data);
            _this.dialogRef.close();
        }
        else {
            _this.fail();
        } }, function (error) { _this.fail(); });
    };
    LoginComponent.prototype.success = function (data) {
        this.loginResult = null;
        this.router.navigate(['/admin/dish']);
    };
    LoginComponent.prototype.fail = function () {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(userService, router, store, dialogRef, dialog) {
        this.userService = userService;
        this.router = router;
        this.store = store;
        this.dialogRef = dialogRef;
    ...
    RegisterComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    RegisterComponent.prototype.loginFunction = function () {
        var _this = this;
        var user = { login: this.userLogin, password: this.userPassword };
        this.store.dispatch(new src_app_store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_6__["AuthPending"](user));
        this.store.select('user').subscribe(function (data) { if (data.userId > 0) {
            _this.success(data);
            _this.dialogRef.close();
        }
    ...
    RegisterComponent.prototype.success = function (data) {
        this.loginResult = null;
        this.router.navigate(['/admin/dish']);
    };
    RegisterComponent.prototype.fail = function () {
        this.loginResult = "User " + this.userLogin + " does not exists!";
    };
...
var SafeImageCssPipe = /** @class */ (function () {
    function SafeImageCssPipe(sanitizer) {
        this.sanitizer = sanitizer;
    }
    SafeImageCssPipe.prototype.transform = function (html) {
        return this.sanitizer.bypassSecurityTrustStyle(html);
    };
    SafeImageCssPipe.ctorParameters = function () { return [
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }
    ]; };
...
var DishService = /** @class */ (function () {
    ...
    DishService.prototype.getAllDishes = function () {
        return this.http.get('https://vladimirsuhov.space/api/dishes');
    };
    DishService.prototype.getDishesByType = function (id) {
        return this.http.get('https://vladimirsuhov.space/api/dishes/bytype/' + id);
    };
    DishService.prototype.postDish = function (dish) {
    ...
    DishService.prototype.removeDish = function (id) {
...
var DishTypesService = /** @class */ (function () {
    function DishTypesService(http) {
        this.http = http;
    }
    DishTypesService.prototype.getAllDishTypes = function () {
        return this.http.get('https://vladimirsuhov.space/api/dishtypes');
    };
    DishTypesService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var UploadService = /** @class */ (function () {
    function UploadService(httpClient, store) {
        this.httpClient = httpClient;
        this.store = store;
    }
    UploadService.prototype.uploadLogo = function (file) {
        var _this = this;
        this.store.select('user').subscribe(function (s) { return _this.user = s; });
    ...
    UploadService.prototype.uploadDishImage = function (file, dishImage) {
        var _this = this;
        this.store.select('user').subscribe(function (s) { return _this.user = s; });
        var reader = new FileReader();
        reader.readAsDataURL(file);
    ...
    UploadService.prototype.loadImage = function (reader) {
    ...
    UploadService.prototype.loadDishImage = function (reader, dishImage) {
        dishImage.image = reader.result.toString();
        this.httpClient.post("https://vladimirsuhov.space/api/DishImages/", dishImage)
            .subscribe(function (s) { return dishImage.dishImageId = s.dishImageId; });
    };
...
var AuthPending = /** @class */ (function () {
    function AuthPending(payload) {
        this.type = AuthActionTypes.Pending;
        this.payload = payload;
    }
    AuthPending.ctorParameters = function () { return [
        { type: User }
    ]; };
    return AuthPending;
}());

var AuthUpdate = /** @class */ (function () {
    function AuthUpdate(payload) {
        this.type = AuthActionTypes.Pending;
        this.payload = payload;
    }
    AuthUpdate.ctorParameters = function () { return [
        { type: User }
    ]; };
    return AuthUpdate;
}());
...
var AuthSuccess = /** @class */ (function () {
    ...
    AuthSuccess.ctorParameters = function () { return [
        { type: User }
    ]; };
    return AuthSuccess;
}());
...
var AuthError = /** @class */ (function () {
    ...
    AuthError.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return AuthError;
}());
...
var initialState = JSON.parse(localStorage.getItem('basket')) || [];
var BasketAdd = /** @class */ (function () {
    function BasketAdd(dish) {
        this.type = BasketActionTypes.Add;
        var elem = initialState.find(function (f) { return f.dish.dishId === dish.dishId; });
        elem
            ? elem.count += 1
            : initialState.push({ dish: dish, count: 1 });
        this.payload = initialState;
    }
    BasketAdd.ctorParameters = function () { return [
        { type: Dish }
    ]; };
    return BasketAdd;
}());

var BasketDecrement = /** @class */ (function () {
    function BasketDecrement(dish) {
        this.type = BasketActionTypes.Decrement;
        initialState.find(function (f) { return f.dish.dishId === dish.dishId; }).count -= 1;
        this.payload = initialState;
    }
    BasketDecrement.ctorParameters = function () { return [
        { type: Dish }
    ]; };
    return BasketDecrement;
}());

var BasketRemove = /** @class */ (function () {
    function BasketRemove(dish) {
        this.type = BasketActionTypes.Remove;
        initialState.splice(initialState.findIndex(function (f) { return f.dish.dishId === dish.dishId; }), 1);
        this.payload = initialState;
    }
    BasketRemove.ctorParameters = function () { return [
        { type: Dish }
    ]; };
    return BasketRemove;
}());

var BasketError = /** @class */ (function () {
    function BasketError(payload) {
        this.type = BasketActionTypes.Error;
        this.payload = payload;
    }
    BasketError.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return BasketError;
}());
...
var AuthEffects = /** @class */ (function () {
    function AuthEffects(actions$, userService) {
        var _this = this;
        this.actions$ = actions$;
        this.user$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_auth_actions__WEBPACK_IMPORTED_MODULE_4__["AuthActionTypes"].Pending), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (action) {
            return _this.userService.login(action.payload).pipe(
            // If successful, dispatch success action with result
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) { return new _actions_auth_actions__WEBPACK_IMPORTED_MODULE_4__["AuthSuccess"](res); }), 
            // If request fails, dispatch failed action
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(new _actions_auth_actions__WEBPACK_IMPORTED_MODULE_4__["AuthError"](err)); }));
        }));
        this.userService = userService;
    }
